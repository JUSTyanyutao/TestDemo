...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="分类管理" />
</c:import>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/category/list">
                                <input type="hidden" name="pid" value="${pid}"/>

                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_name" placeholder="分类名称" class="form-control">
                                    <%--<select id="display" name="search_EQ_isDisplay" style="width:20%"></select>--%>
                                    <label class="control-label">分类状态:</label>
                                    <label class="checkbox">&nbsp;
                                        <input type="checkbox" name="search_EQ_isDisplay" value="1"  />启用  &nbsp;
                                        <input type="checkbox" name="search_EQ_isDisplay" value="0" />禁用
                                    </label>
...
<script src="${ctx}/static/js/category/list.js"></script>
</body>
</html>