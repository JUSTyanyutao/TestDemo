...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="title" value="大家说管理" />
</c:import>
<link href="${ctx}/static/libs/select2/css/select2.css" rel="stylesheet" type="text/css" />
</head>
<c:set var="mainTitle" value="大家说管理" />
<c:set var="subTitle" value="大家说列表" />
<style type="text/css">
    .messageTd{
        max-width: 100px;
        white-space: nowrap;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/goods/show/list">
...
<script src="${ctx}/static/js/goodsShow/list.js"></script>
