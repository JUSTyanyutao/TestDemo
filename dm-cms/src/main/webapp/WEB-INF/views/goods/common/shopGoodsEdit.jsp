	                            ...
	                            <div class="row">
	                                <div class="col-md-12">
										...
										<%--<div class="form-group">--%>
											...
											<%--<div class="col-md-8">--%>
												<%--<select  name="categoryId" id="category" class="form-control select1" data-select="${goods.categoryId}" ></select>--%>
												<input type="hidden" value="0" name="categoryId" />
												<%--<input  value="其他商品" class="form-control" disabled />--%>
										...
										<div class="form-group" >
											...
											<div class="col-md-7">
												<input type="hidden" value="2" name="userType" readonly />
												<label class="form-control">企业用户</label>
												<%--<input type="radio"--%>
...
<script src="${ctx}/static/js/goods/common/shopGoodsEdit.js"></script>
...
//	var editor1 = new Editor("#detailContent");
//	var editor2 = new Editor("#specContent");
//	var editor3 = new Editor("#serviceProcessContent");
