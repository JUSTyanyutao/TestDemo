...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="商品管理" />
</c:import>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/goods/common/list">
                                ...
                                <div class="action-group">
                                    <a href="javascript:void(0);"  style="margin-left:15px;"  class="btn btn-recommendFlag btn-success pull-right">一键置顶</a>
                                    <a href="javascript:void(0);"  style="margin-left:15px;"  class="btn btn-disRecommendFlag btn-success pull-right">取消置顶</a>
                                    <%--<a href="javascript:void(0);" id="export" style="margin-left:15px;"  class="btn btn-export btn-success pull-right">导出Excel</a>--%>
                                    <button type="button" class="btn btn-add btn-success pull-right">添加车模商品</button>
                                    <button type="button" class="btn btn-addShopGoods btn-success pull-right">添加企业商品</button>
                                    <button type="button" class="btn btn-addOthers btn-success pull-right">添加其他商品</button>
...
<script src="${ctx}/static/js/goods/common/list.js"></script>
