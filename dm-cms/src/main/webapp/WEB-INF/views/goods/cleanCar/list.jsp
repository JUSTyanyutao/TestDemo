                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/goods/cleanCar/list">
                                ...
                                <div class="action-group">
                                    ...
                                    <button type="button" class="btn btn-add btn-success pull-right">添加美容洗车</button>
...
<script src="${ctx}/static/js/goods/cleanCar/list.js"></script>
