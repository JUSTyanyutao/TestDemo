	                                ...
	                                <div class="col-md-12">
										...
										<%--<div class="form-group">--%>
											...
											<%--<div class="col-md-8">--%>
												<%--&lt;%&ndash;<select  name="categoryId" id="category" class="form-control select1" data-select="${goods.categoryId}" ></select>&ndash;%&gt;--%>
													...
													<%--<input  value="美容洗车" class="form-control" disabled />--%>
											<%--</div>--%>
										<%--</div>--%>
										...
										<div class="form-group" >
											...
											<div class="col-md-7">
												...
												<input type="text" class="form-control"  value="美容洗车" disabled />
											</div>
										</div>
...
<script src="${ctx}/static/js/goods/cleanCar/edit.js"></script>
