                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/goods/service/list">
                                ...
                                <div class="action-group">
                                    ...
                                    <button type="button" class="btn btn-add btn-success pull-right">添加服务商品</button>
...
<script src="${ctx}/static/js/goods/service/list.js"></script>
