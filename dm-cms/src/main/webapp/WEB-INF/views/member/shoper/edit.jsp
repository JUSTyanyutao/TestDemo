...
<head>
    <c:import url="/WEB-INF/layouts/header.jsp">
        <c:param name="question" value="企业用户管理 - 达膜" />
    </c:import>
...
<c:set var="mainTitle" value="企业用户管理" />
<c:set var="subTitle" value="${empty member.id ? '添加企业用户' : '编辑企业用户'}" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="form-edit" role="form" method="POST" class="form-horizontal"  action="${ctx}/member/saveShoperMember">
		                               ...
		                               <div class="row">
										   <div class="col-md-6">
											   <div class="form-group">
												   ...
												   <div class="col-sm-9">
													   <select id="shop" name="shop" class="form-control" data-select="${shopList}">
													   </select>
												   </div>
											   </div>
										   </div>
		                               ...
		                               <div class="row">
		                                  	...
		                                  	<div class="col-md-6">
				                               	<div class="form-group">
				                                      <label class="col-sm-3 control-label">企业用户身份:</label>
				                                      <div class="col-sm-9">
														  <input  class="form-control" value="企业用户" disabled  />
...
<script src="${ctx}/static/js/member/shoper/edit.js"></script>
</body>
