...
<c:set var="subTitle" value="企业用户列表" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/member/shoper/list">
                                ...
                                <div class="action-group">
                                    ...
                                    <a href="${ctx}/member/editShoperMember" class="btn btn-add btn-success pull-right">添加企业用户</a>
                                    ...
                                    <a href="javascript:void (0)" class="btn btn-add btn-success pull-right btn-address">企业用户地址</a>
...
<script src="${ctx}/static/js/member/shoper/list.js"></script>
