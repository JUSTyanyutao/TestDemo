...
<c:set var="subTitle" value="${empty member.id ? '添加会员' : '编辑会员'}" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="form-edit" role="form" method="POST" class="form-horizontal"  action="${ctx}/member/saveMember">
		                               ...
		                               <div class="row">
		                                  	...
		                                  	<div class="col-md-6">
				                               	<div class="form-group">
				                                      <label class="col-sm-3 control-label">会员身份:</label>
				                                      <div class="col-sm-9">
														  <input  class="form-control" value="普通会员" disabled  />
...
<script src="${ctx}/static/js/member/edit.js"></script>
</body>
