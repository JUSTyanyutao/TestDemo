                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/member/addresses">
                                ...
                                <div class="action-group">
                                    <a href="javascript:history.go(-1);" class="btn btn-sm btn-back btn-primary">返回</a>
                                    <%--<div class="btn-group">--%>
...
<script src="${ctx}/static/js/member/address/list.js"></script>
<%--<script>--%>
    <%--function exportRecords(){--%>
        <%--var currentHref = window.location.href;--%>
        <%--var newHref = window.ctx+"/member/market/records/export?fileName=marketRecords";--%>
