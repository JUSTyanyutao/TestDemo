                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/worker/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_member.mobile" placeholder="手机" class="form-control">
                                    <input type="text" name="search_LIKE_name" placeholder="姓名" class="form-control">
                                ...
                                <div class="search-group form-inline">
                                    <label class="control-label">技师状态:</label>
                                    <label class="checkbox">&nbsp;
                                        <input type="checkbox" name="search_EQ_applyStatus" value="0"  />待审核  &nbsp;
                                        <input type="checkbox" name="search_EQ_applyStatus" value="1" />已审核   &nbsp;
                                        <input type="checkbox" name="search_EQ_applyStatus" value="2" />反驳
                                    </label>
                                </div>
                                ...
                                <div class="action-group">
                                    ...
                                    <a href="${ctx}/worker/add" class="btn btn-add btn-success pull-right">添加技师</a>
...
<script src="${ctx}/static/js/worker/list.js"></script>
