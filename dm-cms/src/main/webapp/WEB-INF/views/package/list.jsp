...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="套餐管理" />
</c:import>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/package/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_name" placeholder="套餐名称" class="form-control">
...
<script src="${ctx}/static/js/package/list.js"></script>
