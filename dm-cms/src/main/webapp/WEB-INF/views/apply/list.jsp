...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="申请修改商品管理 - 怎么吃" />
</c:import>
<link href="${ctx}/static/libs/select2/css/select2.css" rel="stylesheet" type="text/css" />
</head>
<c:set var="mainTitle" value="申请修改商品管理" />
<c:set var="subTitle" value="申请修改商品列表" />
<!-- 审批状态 -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/goodsApproval/applyList">
                                <div class="search-group form-inline">
                                    ...
                                    <select name="search_EQ_status" class="form-control" style="width:15%">
										<option value="">请选审批状态</option>
										<c:forEach items="${approvalStatus}" var="apStatus">
											<option value="${apStatus.value}"  >${apStatus.label}</option>
										</c:forEach>
									</select>
                                    <button type="button" class="btn btn-primary btn-search">搜索</button>
                                </div>
                                <div class="action-group">
                                    <a href="${ctx}/goodsApproval/addApply" class="btn btn-add btn-success pull-right">添加</a>
                                    <div class="btn-group">
...
<script src="${ctx}/static/js/apply/list.js"></script>
</body>
</html>