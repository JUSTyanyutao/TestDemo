                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/memberPrepaid">
                                ...
                                <div class="action-group">
                                    <a href="${ctx}/memberPrepaid/addMemberPrepaid" class="btn btn-add btn-success pull-right">添加充值</a>
                                    <div class="btn-group">
...
<script src="${ctx}/static/js/memberPrepaid/list.js"></script>
</body>
