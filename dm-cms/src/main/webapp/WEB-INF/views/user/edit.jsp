...
<c:set var="question" value="${empty user ? '添加' : '编辑'}用户" />
<div class="modal-header">
    <button type="button" data-dismiss="modal" aria-label="Close" class="close">
        <span aria-hidden="true">×</span>
    </button>
    <h4 id="editModalLabel" class="modal-question">${question}</h4>
</div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>帐号</label>
                    <input type="text" name="mobile" id="mobile" value="${user.mobile}" placeholder="请输入登陆帐号" class="form-control">
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
