...
<c:set var="mainTitle" value="特性管理" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/attribute/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_name" placeholder="特性名称" class="form-control">
...
<script src="${ctx}/static/js/attribute/list.js"></script>
