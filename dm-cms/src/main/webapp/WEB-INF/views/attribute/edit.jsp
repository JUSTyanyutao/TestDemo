...
<head>
    <c:import url="/WEB-INF/layouts/header.jsp">
        <c:param name="question" value="特性类型管理 - 达膜" />
    </c:import>
...
<c:set var="mainTitle" value="特性类型管理" />
<c:set var="subTitle" value="${empty attribute ? '添加特性类型' : '保存特性类型'}" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form id="form-edit" role="form" method="POST"  enctype="multipart/form-data" class="form-horizontal" action="${ctx}/attribute/save">
	                            <div class="row">
	                                <div class="col-md-12">
	                                     <input type="hidden" id="id" name="id" value="${attribute.id}">
	                                     <div class="form-group">
	                                         <label class="col-md-2 control-label">特性类型:</label>
	                                         <div class="col-md-8">
	                                         	<input type="text" name="name" id="attrValue" placeholder="请输入特性类型"
										...
										<%--<div class="form-group">--%>
											...
											<%--<div class="col-md-8">--%>
												<%--<input type="text" name="remark" id="remark" placeholder="请输入备注"--%>
													   <%--class="form-control" value="${attribute.remark}">--%>
											<%--</div>--%>
										<%--</div>--%>
	                                     <%--<div class="form-group">--%>
	                                     ...
	                                     <c:if test="${!empty attribute.id}">
	                                     		<div class="form-group">
			                                         <label class="col-md-2 control-label">创建时间:</label>
			                                        	<div class="col-md-6">
			                                        		<input type="text" value="<fmt:formatDate pattern='yyyy-MM-dd hh:mm:ss' value='${attribute.createTime}'/>"
			                                     ...
			                                     <div class="form-group">
			                                         <label class="col-md-2 control-label">更新时间:</label>
			                                        	<div class="col-md-6">
			                                        		<input type="text" value="<fmt:formatDate pattern='yyyy-MM-dd hh:mm:ss' value='${attribute.updateTime}'/>"
	                             ...
	                             <button type="submit" class="btn btn-submit btn-sm btn-primary"
                                                data-loading-text="${empty attribute ? "添加" : "保存"}中...">
                                            ${empty attribute ? "添 加" : "保存"}
                                 </button>
...
<script src="${ctx}/static/js/attribute/edit.js"></script>
</body>
</html>