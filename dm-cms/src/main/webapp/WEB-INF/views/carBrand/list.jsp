...
<c:set var="mainTitle" value="车 品牌管理" />
<c:set var="subTitle" value="车 品牌列表" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/carBrand/list">
...
<script src="${ctx}/static/js/carBrand/list.js"></script>
</body>
</html>