                           ...
                           <form id="form-edit" role="form" method="POST" class="form-horizontal" action="${ctx}/worker/save">
	                                <div class="col-md-12">
	                                     <div class="form-group">
	                                         ...
	                                         <div class="col-md-8">
												 <input type="text"
														class="form-control" value="${goodsComment.member.mobile}" readonly>
	                                         </div>
	                                     </div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text"
													   class="form-control" value="${goodsComment.goods.name}" readonly>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text"
													   class="form-control" value="${goodsComment.comment}" readonly>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" value=
														'<c:if test="${goodsComment.recommend == 1}">置顶</c:if><c:if test="${goodsComment.recommend == 0}">普通</c:if>'
													 readonly  />
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text" class="form-control" value=
												'<c:if test="${goodsComment.status == 0}">待审核</c:if><c:if test="${goodsComment.status == 1}">已审核</c:if><c:if test="${goodsComment.status == 2}">反驳</c:if>' readonly />
											</div>
										</div>
										...
										<%--<div class="form-group">--%>
											...
											<%--<div class="col-md-8">--%>
												<%--<input type="text" class="form-control"--%>
													   <%--value=<fmt:formatDate value="${goodsComment.commentTime}" pattern="yyyy-MM-dd HH:mm"/>>--%>
											<%--</div>--%>
										<%--</div>--%>
										...
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text"  readonly
													   class="form-control" value="${goodsComment.shopScore}星">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text"  readonly
													   class="form-control" value="${goodsComment.workerScore}星">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-md-8">
												<input type="text"  readonly
													   class="form-control" value="${goodsComment.goodsScore}星">
											</div>
										</div>
                            </form>
                        </div>
