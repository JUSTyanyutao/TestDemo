...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="技师结算管理" />
</c:import>
...
<c:set var="mainTitle" value="技师结算管理" />
<c:set var="subTitle" value="技师结算列表" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/order/worker/statistics/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_worker.name" placeholder="技师名称" class="form-control">
                                ...
                                <%--<div class="search-group form-inline">--%>
                                    <%--<label class="control-label">技师结算状态:</label>--%>
...
<script src="${ctx}/static/js/workerStatistics/list.js"></script>
