                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/shop/4s/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_name" placeholder="公司名称" class="form-control">
                                    <input type="text" name="search_LIKE_address" placeholder="场地地址" class="form-control">
                                ...
                                <div class="action-group">
                                    <a href="${ctx}/shop/4s/edit" class="btn btn-add btn-success pull-right">添加</a>
                                    <div class="btn-group">
...
<script src="${ctx}/static/js/shop/4s/list.js"></script>
