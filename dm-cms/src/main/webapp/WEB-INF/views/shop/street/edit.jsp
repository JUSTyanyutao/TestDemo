                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form id="form-edit" role="form" method="POST" class="form-horizontal" action="${ctx}/shop/save/street">
	                                <div class="col-md-12">
										...
										<%--<div class="form-group">--%>
											<%--<label class="col-md-2 control-label">4s店会员:</label>--%>
											<%--<div class="col-md-8">--%>
												<%--<select  name="memberShop.memberId" id="member" class="form-control select1" data-select="${shop.memberShop.memberId}" ></select>--%>
											<%--</div>--%>
										<%--</div>--%>
...
<script src="${ctx}/static/js/shop/street/edit.js"></script>
