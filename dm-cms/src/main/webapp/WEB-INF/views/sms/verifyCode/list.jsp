...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="短信管理 - 达膜贴膜" />
</c:import>
</head>
<c:set var="mainTitle" value="短信管理" />
<c:set var="subTitle" value="短信列表" />
<body>
<div class="wrapper">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/sms/verify/code/list">
...
<script src="${ctx}/static/js/sms/verifyCode/list.js"></script>
