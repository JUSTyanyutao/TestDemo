...
<%@ page import="com.mxep.model.enums.EnumSmsType" %>
...
<c:set var="subTitle" value="短信模版列表" />
<body>
<div class="wrapper">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" method="POST" action="${ctx}/sms/template/list">
                                <div class="search-group form-inline">
                                 <%--<select class="form-control" name="search_EQ_type" style="width:20%">--%>
                                        <%--<c:set value="<%=EnumSmsType.values()%>" var="types"/>--%>
                                    	<%--<option value="">请选择短信类型</option>--%>
                                    	<%--<c:forEach items="${types}" var="type">--%>
                                    		<%--<option value="${type.value}">${type.label}</option>--%>
                                    	<%--</c:forEach>--%>
                                 <%--</select>--%>
                                    <input type="text" name="search_LIKE_content" placeholder="模版内容" class="form-control">
                                    <%--<select class="form-control" name="search_EQ_status" style="width:20%">--%>
                                        <%--<c:set value="<%=EnumSmsStatus.values()%>" var="statuses"/>--%>
                                        <%--<option value="">请选择短信状态</option>--%>
...
<script src="${ctx}/static/js/sms/template/list.js"></script>
