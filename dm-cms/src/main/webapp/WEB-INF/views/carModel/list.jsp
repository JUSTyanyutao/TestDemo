                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/carModel/list/${carSeries.id}">
                                ...
                                <div class="search-group form-inline">
                                    ...
                                    <label class="control-label">车型状态:</label>
                                ...
                                <%--<a href="javascript:;" style="margin-left:15px;" onclick="exportGoods()" class="btn btn-export btn-success pull-right">导出Excel</a>--%>
                                    ...
                                    <a href="${ctx}/carSeries/list/${carSeries.brandId}" class="btn btn-success pull-right">返回</a>
...
<script src="${ctx}/static/js/carModel/list.js"></script>
</body>
</html>