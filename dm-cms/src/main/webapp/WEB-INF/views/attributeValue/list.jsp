...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="特性管理" />
</c:import>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/attribute/value/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_attrValue" placeholder="特性名称" class="form-control">
                                    <select class="form-control" name="search_EQ_attrId" style="width:20%">
                                ...
                                <div class="search-group form-inline">
                                    <label class="control-label">特性状态:</label>
...
<script src="${ctx}/static/js/attributeValue/list.js"></script>
