...
<head>
    <c:import url="/WEB-INF/layouts/header.jsp">
        <c:param name="question" value="商品订单管理" />
    </c:import>
    <link href="${ctx}/static/libs/select2/css/select2.css" rel="stylesheet" type="text/css" />
</head>

<c:set var="mainTitle" value="商品订单管理" />
<c:set var="subTitle" value="商品订单列表" />
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            <form id="pagination-form" class="" method="POST" action="${ctx}/order/goods/list">
                                ...
                                <div class="search-group form-inline">
                                	<div style="height:50px;">
                                    	...
                                    	<a href="javascript:;" style="margin-left:15px;"  class="btn btn-updateOrderSn btn-success pull-right">发货</a>
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 id="myModalLabelLarge" class="modal-title">发货</h4>
			</div>
...
<script src="${ctx}/static/js/order/goods/list.js"></script>
