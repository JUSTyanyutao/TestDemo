...
<c:import url="/WEB-INF/layouts/header.jsp">
    <c:param name="question" value="品牌管理" />
</c:import>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body table-fit">
                            ...
                            <form id="pagination-form" method="POST" action="${ctx}/brand/list">
                                <div class="search-group form-inline">
                                    <input type="text" name="search_LIKE_name" placeholder="品牌名称" class="form-control">
...
<script src="${ctx}/static/js/brand/list.js"></script>
