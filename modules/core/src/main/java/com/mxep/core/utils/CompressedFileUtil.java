...
public class CompressedFileUtil {
	...
	public static void main(String[] args) {
		...
		try {
			String resourcesPath = "D:/WNPHP/nginx/html/data/scenic/4";
		    String targetPath = "D:/WNPHP/nginx/html/data/scenic/zip";

			compressedFileUtil.compressedFile(resourcesPath, targetPath);
